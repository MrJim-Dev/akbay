    ...
    <section id="home">
      <div className="container">
        <h3
          ...
          data-text="Be the reason someone smiles"
          data-align="center"
        >
            ...
            <ul>
              <li className="prev" data-index={1}>
                <div className="item">
                  ...
                  <div className="item_in">
                    <div className="img" data-bg-img="/img/campaign/donation1.jpg" />
                  </div>
                </div>
              </li>
              <li className="active" data-index={2}>
                <div className="item">
                  ...
                  <div className="item_in">
                    <div className="img" data-bg-img="/img/campaign/donation2.jpg" />
                  </div>
                </div>
              </li>
              <li className="next" data-index={3}>
                <div className="item has_video">
                  ...
                  <div className="item_in">
                    <div className="img" data-bg-img="/img/campaign/donation3.jpg" />
                  </div>
                </div>
              </li>
              <li className="next2" data-index={4}>
                <div className="item">
                  ...
                  <div className="item_in">
                    <div className="img" data-bg-img="/img/campaign/donation4.jpg" />
                  </div>
                </div>
              </li>
              <li data-index={5}>
                <div className="item">
                  ...
                  <div className="item_in">
                    <div className="img" data-bg-img="/img/campaign/donation5.jpg" />
                  </div>
                </div>
              </li>
              <li data-index={6}>
                <div className="item">
                  ...
                  <div className="item_in">
                    <div className="img" data-bg-img="/img/campaign/donation6.jpg" />
                  </div>
                </div>
              </li>
            </ul>
        ...
        <div className="fn_cs_desc">
          <p>
            Join our mission of sharing and caring. Every contribution is a step towards helping those in need. Discover stories of hope and provide support through Akbay.
          </p>
          <a
            href="#"
