        ...
        <div className="fn_cs_contact_form lg:w-[50%] sm:w-[100%] mx-auto">
            ...
            >
                ...
                <div className="mt-5">
                    ...
                    <p className="text-right mt-3"><Link href="#">Forgot Password?</Link></p>
                ...
                <p className="text-center">Don&apos;t have an account? <Link href="/signup" className="text-[blue]">Sign Up</Link></p>
            </form>
            </div>
  );
};
